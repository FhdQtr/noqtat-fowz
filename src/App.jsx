          ...
          if (isFirstPlayer) {
            ...
            (async () => {
              try {
                ...
                // Join the other players into the room
                ...
                matchmakingProcessingRef.current = false;
                setOnlineError("خطأ في إنشاء الغرفة: " + e.message);
              }
            })();
          } else {
            // I'm not host, poll for the room that has my name
                  ...
                  for (const [rCode, rData] of Object.entries(rooms)) {
                    if (rData.players) {
                      ...
                      if (playerNames.includes(playerName)) {
                        ...
                        roomListenerRef.current = roomUnsub;
                        // Don't go to room screen, wait for game to start via listener
                        return;
                      }
                    }
                  }
            ...
            setTimeout(() => { clearInterval(checkRoom); matchmakingProcessingRef.current = false; }, 60000);
          }
        }
      });
