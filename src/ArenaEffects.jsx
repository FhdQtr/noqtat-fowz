...
border: `2px solid ${ powerup.owned ? theme.yellow : isLocked ? theme.border : theme.border }`,
borderRadius: 14,
padding: 16,
textAlign: “center”,
...
<style>{`@keyframes arenaPointsPop { 0% { opacity: 0; transform: scale(0.3) translateY(20px); } 30% { opacity: 1; transform: scale(1.3) translateY(-10px); } 70% { opacity: 1; transform: scale(1) translateY(-30px); } 100% { opacity: 0; transform: scale(0.9) translateY(-60px); } } @keyframes arenaConfettiBurst { 0% { opacity: 1; transform: translate(-50%, -50%) translate(0, 0) scale(0.5); } 100% { opacity: 0; transform: translate(-50%, -50%) translate( calc(cos(var(--angle)) * var(--distance)), calc(sin(var(--angle)) * var(--distance)) ) scale(1) rotate(720deg); } }`}</style>
</div>
);
}
...
<style>{`@keyframes arenaHeroRise { from { opacity: 0; transform: translateY(40px) scale(0.9); } to { opacity: 1; transform: translateY(0) scale(1); } }`}</style>
</div>
);
}
...
<style>{`@keyframes arenaEffectFade { 0% { opacity: 0; } 20% { opacity: 1; } 80% { opacity: 1; } 100% { opacity: 0; } } @keyframes arenaEffectPop { from { transform: scale(0.5); } to { transform: scale(1); } } @keyframes arenaEffectShake { from { transform: rotate(-5deg); } to { transform: rotate(5deg); } }`}</style>
</div>
);
}
...
return (
<style>{`@keyframes arenaModalFade { from { opacity: 0; } to { opacity: 1; } } @keyframes arenaModalPop { from { opacity: 0; transform: scale(0.92); } to { opacity: 1; transform: scale(1); } }`}</style>
);
}